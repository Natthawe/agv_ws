...
def generate_launch_description():
    ...
    # )
    # omron_dir = get_package_share_directory('omron_b5l_tof')
    # launch_omron_pkg = os.path.join(omron_dir, 'launch')
    ...
    # omron_b5l_a
        ...
        # ),
        # IncludeLaunchDescription(
        #     PythonLaunchDescriptionSource(os.path.join(launch_omron_pkg, 'omron_b5l_tof_launch.py'))
        # ),        
