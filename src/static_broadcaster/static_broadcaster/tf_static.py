...
class StaticFramePublisher(Node):
    ...
    def make_transforms(self):
        ...
        base_link_to_bno055.transform.translation.x = -0.22 #0.23
        base_link_to_bno055.transform.translation.y = 0.0
        base_link_to_bno055.transform.translation.z = 0.185
        ...
        # base_link_to_omron.transform.translation.z = 0.19 #0.185
        ...
        base_link_to_laser.transform.translation.x = 0.0 #0.3
        base_link_to_laser.transform.translation.y = 0.0
        base_link_to_laser.transform.translation.z = 0.25 #0.185
