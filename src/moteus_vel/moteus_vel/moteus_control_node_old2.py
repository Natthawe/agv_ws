...
class MoteusControlNode(Node):
    def __init__(self):
        ...
        self.radius_of_wheels = float(self.declare_parameter('radius_of_wheels', 0.127).value)  
